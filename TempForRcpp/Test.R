...
params <- list(standardize=standardize, K=K,c = c,c_max = c_max,iter_max = iter_max,
               ...
               m = m,w = w,alpha = alpha,seed = seed,exe_print = TRUE, set_seed= TRUE)
...
save(find_candidate_motifs_results_prof, file="find_candidate_motifs_results_prof.RData")
# to load the results of the prof 
load("../TempForRcpp/find_candidate_motifs_results_prof.RData")
