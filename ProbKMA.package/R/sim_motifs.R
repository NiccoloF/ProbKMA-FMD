#' Simulated database for functionals motifs discovery (sim_motifs)
#'
#' 20 curves of length 200 (corresponding to 201 evaluation points) with 2
#' different motifs of length 60 (corresponding to 61 evaluation points), with
...
#' Chiaromonte (scenario (1) of Functional motif discovery simulation section).
#'
#' @format List with the 10 following elements:
#' \describe{
#' \item{\code{Y0}}{list of 20 vectors with the evaluation of the 20 curves}
#' \item{\code{Y1}}{list of 20 vectors with the evaluation of the 20 curve
#' derivatives}
...
#' \item{\code{fd_curves}}{list of 20 functional data objects (class fd from
#' package fda) with the 20 curves}
#' \item{\code{motifs_in_curves}}{list of 20 objects, one for each curve,
...
#' \item{\code{freq_motifs}}{list of 20 vectors with the frequency (number of
